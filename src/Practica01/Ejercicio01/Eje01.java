...
cada línea en la salida estándar. Para ello, dentro de una nueva clase escriba un metodo por
...
c. Que realice lo pedido sin utilizar estructuras de control iterativas (for, while, do
                                                                                 while).
Por último, escriba en el metodo de clase main el llamado a cada uno de los métodos
